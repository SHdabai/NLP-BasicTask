...
def keyWord():
    text = load_data('../otherFunction/doc/01.txt')
...
class WordSegmentation(object):
    ...
    def segmentPos(self, text, lower=True, use_stop_words=True, use_speech_tags_filter=True):
        """对一段文本进行分词，返回list类型的分词结果
        ...
        # 去除特殊符号
        word_list = [w for w in jieba_result if w.flag != 'x']
