...
__url__ = 'https://github.com/wufeifei/Translate'
__license__ = 'MIT'
...
class Dict:
    ...
    def parse(self):
        ...
        if code == 0:  # Success
            ...
            # return (u'\033[1;31m# \033[0m {0} {1}'.format(
            #     self.content['query'], self.content['translation'][0]))

            return (u'{0}'.format(self.content['translation'][0]))
